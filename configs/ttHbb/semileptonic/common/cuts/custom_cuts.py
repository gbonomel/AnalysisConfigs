...
def get_ttcc_max(ttcc_wp, name=None):
    if name == None:
        name = f"spanet_ttcc_max_ttcc_{ttcc_wp}"
    return Cut(name=name, params={"ttcc_wp" : ttcc_wp}, function=cuts_f.spanet_ttcc_max)

def get_ttcc_min(ttcc_wp, name=None):
    if name == None:
        name = f"spanet_ttcc_min_ttcc_{ttcc_wp}"
    return Cut(name=name, params={"ttcc_wp" : ttcc_wp}, function=cuts_f.spanet_ttcc_min)
